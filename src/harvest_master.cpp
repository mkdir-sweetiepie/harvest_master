...
node_status_sub_ = this->create_subscription<std_msgs::msg::String>(”/node_ready”, 10, std::bind(&MasterNode::nodeStatusCallback, this, std::placeholders::*1));
movement_sub* = this->create_subscription<std_msgs::msg::Bool>(”/movement_complete”, 10, std::bind(&MasterNode::movementCallback, this, std::placeholders::*1));
fruit_detection_sub* = this->create_subscription<vision_msgs::msg::DetectedCropArray>(”/detected_crops”, 10, std::bind(&MasterNode::fruitDetectionCallback, this, std::placeholders::*1));
tsp_sub* = this->create_subscription<std_msgs::msg::Int32MultiArray>(”/tsp_result”, 10, std::bind(&MasterNode::tspCallback, this, std::placeholders::*1));
foundation_sub* = this->create_subscription<geometry_msgs::msg::Point>(”/cutting_point”, 10, std::bind(&MasterNode::foundationCallback, this, std::placeholders::*1));
arrival_sub* = this->create_subscription<std_msgs::msg::Bool>(”/arrival_complete”, 10, std::bind(&MasterNode::arrivalCallback, this, std::placeholders::_1));
}
